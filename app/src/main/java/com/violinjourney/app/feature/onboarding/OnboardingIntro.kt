        ...
        Column(verticalArrangement = Arrangement.spacedBy(OnboardingDimens.TitleToBody)) {
            when (step) {
                OnboardingStep.WELCOME -> {
                    OnboardingTitle(R.string.app_name, titleStyle)
                    OnboardingBody(R.string.onboarding_welcome_text, bodyStyle)
                }
                OnboardingStep.LIVE -> {
                    OnboardingTitle(R.string.onboarding_live_title, titleStyle)
                    OnboardingBody(R.string.onboarding_live_text, bodyStyle)
                }
                OnboardingStep.JOURNEY -> OnboardingTitle(R.string.onboarding_journey_title, titleStyle)
                OnboardingStep.DATA -> {
                    OnboardingTitle(R.string.onboarding_data_title, titleStyle)
                    OnboardingBody(R.string.onboarding_data_text, bodyStyle)
                }
                else -> Unit
            }
        }
        when (step) {
            OnboardingStep.LIVE -> OnboardingFoot(R.string.onboarding_live_foot)
...
private fun ctaOf(step: OnboardingStep): Int = when (step) {
    OnboardingStep.WELCOME -> R.string.onboarding_welcome_cta
    OnboardingStep.DATA -> R.string.onboarding_data_cta
