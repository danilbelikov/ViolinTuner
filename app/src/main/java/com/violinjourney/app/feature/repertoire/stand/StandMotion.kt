...
/** Durations of the music stand, from the `anims` table of the handoff. */
internal object StandMotion {
    ...
    const val REC_PULSE_MS = 1_200
    const val REC_PULSE_MIN_ALPHA = 0.35f
}
