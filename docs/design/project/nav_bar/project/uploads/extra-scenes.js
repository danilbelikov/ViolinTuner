...
const planeAt = (x, y, dir = 1) => [L('lamp', PG([[x - 11 * dir, y], [x + 8 * dir, y - 1.6], [x + 12 * dir, y], [x + 8 * dir, y + 1.6]]), 0), L('lamp', PG([[x - 1 * dir, y], [x - 6 * dir, y - 7], [x - 3 * dir, y - 7], [x + 4 * dir, y]]), 0), L('lamp', PG([[x - 9 * dir, y], [x - 12 * dir, y - 5], [x - 10 * dir, y - 5], [x - 6 * dir, y]]), 0), L('rgba(255,90,70,1)', C(x - 1 * dir, y + 2, 1.3), 0, { anim: 'flash:1.4' })];
