...
@Composable
fun GiftSheetContent(gift: Gift, onAccept: () -> Unit, modifier: Modifier = Modifier, animated: Boolean = true) {
    val colors = MaterialTheme.colorScheme
    val glowColor = ViolinTheme.progressColors.giftGlow
    val name = stringArrayResource(Res.array.progress_trophy_names).getOrElse(gift.index) { "" }
