 ...
 */
class ArtScene(val gradients: Map<String, ArtGradient>, val layers: List<ArtLayer>)

/** A stop of a gradient: [color] is `#RRGGBB`, or [ZONE] — the colour of the zone of the moment (36b). */
data class ArtStop(val offset: Float, val color: String, val alpha: Float)

sealed interface ArtGradient {
